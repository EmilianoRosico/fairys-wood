...
function Footer() {
  ...
  return (
    <footer className="shadow pt-3">
          ...
          <div className="col-md-6 text-center pb-4">
            ...
            <ul className="list-group list-group-flush">
              <li className="list-group-item footer-color">
                <a
                  href="https://api.whatsapp.com/send?phone=541127624909&text=Hola, visite la WEB y deseo recibir más información!"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li className="list-group-item footer-color">
                <a
                  href="https://www.instagram.com/fairyswood/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <i className="ig-text">
      ...
      <div className=" p-2 mb-2  text-white bg-secondary bg-gradient text-center">
        Powered by {"   "}
        <a
          href="https://www.linkedin.com/in/emilianorosico/"
          target="_blank"
